...
const { name1, agePeople = 25, addresses: { city }, emailPeople } = people;
...
console.log(othersNumber); // Output: [3, 4, 5]
...
for (const flight of flights.split('+')) {
    ...
    // console.log("check ",type, from, to ,time)
...
const arrNumber1 = [1, 2];
rest.set(arrNumber1, 'Test');
rest.set(document.querySelector('h1'), 'Heading');
console.log(rest);
console.log(rest.size);

console.log(rest.get(arrNumber1));
...
///////////////////////////////////////
// The for-of Loop
const menuRestaurant = [...restaurant.starterMenu, ...restaurant.mainMenu];

for (const item of menuRestaurant) console.log(item);

for (const [i, el] of menuRestaurant.entries()) {
    console.log(`${i + 1}: ${el}`);
}
...
const arr33 = [7, 8, 9];
const badNewArr = [1, 2, arr33[0], arr33[1], arr33[2]];
console.log(badNewArr);

const newArr = [1, 2, ...arr33];
console.log(newArr);
